    ...
    const recentBooking = async () => {
        await fetch("https://rental-service-be.herokuapp.com/bookingDetails", {
            ...
            .then((res) => {
                ...
                setTotalFare(res.booking.fare);
                console.log("Fare = ", totalFare);
                if(res.message != "No booking") {
                    setCars(res.booking.car);
                    console.log("car = ", cars);
                    setStartDate(res.booking.startDate);
                    setEndDate(res.booking.endDate);
    ...
    return (
        <div className="booking-container">
            ...
            <section className="booking-details" id="hide">
                <h2 id="error-msg" hidden>No bookings found</h2>
                <ul id="booking-list">
